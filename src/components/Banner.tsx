export default function Banner() {
  return (
    <div className="mx-auto flex h-[530px] max-w-7xl flex-col items-center justify-center gap-6 bg-black/30 bg-[url('https://assets.website-files.com/5be96251aaba7a7b19ecdf69/5be96251aaba7a58aaecdfba_Header-Pic.jpg')] bg-cover bg-bottom bg-blend-darken">
